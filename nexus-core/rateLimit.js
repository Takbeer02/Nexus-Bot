...
class RateLimit {
  constructor() {
    ...
    this.windowMs = config.systemConfig.system.performance.messageRateLimit.windowMs;  // 60000ms
    this.max = config.systemConfig.system.performance.messageRateLimit.max;           // 10 requests
  }
